...
public class MappersToDTOTest {
    ...
    ControlWork controlWork = ControlWork.builder().name("c1")
            ...
            .build();
    create.create.models.Test test = create.create.models.Test.builder().name("t")
            .questions(new ArrayList<>() {{
                add(question);
            }})
            .isFinal(true)
    ...
    private void testTest(TestDTO testDTO, create.create.models.Test test) {
